    ...
    public class AboutWindow : EditorWindow
    {
        ...
        public void OnGUI ()
        {
            ...
            if (engineVersion.Final)
            {
                ...
                EditorGUILayout.LabelField("<color=red>Outdated Version</color>", EditorStyles.boldLabel);
                EditorStyles.boldLabel.richText = false;
                EditorGUILayout.LabelField("This final release is out of support. Get access to the latest supported release by registering your license.", EditorStyles.wordWrappedLabel);
                if (GUILayout.Button("Register Naninovel")) Application.OpenURL("https://naninovel.com/register");
                GUILayout.Space(7);
            }
