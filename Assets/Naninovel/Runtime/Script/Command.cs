...
namespace Naninovel
{
    ...
    public abstract class Command
    {
        ...
        /// </summary>
        public bool ShouldExecute => string.IsNullOrEmpty(ConditionalExpression) || ExpressionEvaluator.Evaluate<bool>(ConditionalExpression, Err);
        /// <summary>
        ...
        /// </summary>
        public void Log (string message) => Engine.Log(message, PlaybackSpot);

        /// <summary>
        /// Logs a warning to the console; will include script name and line number of the command.
        /// </summary>
        public void Warn (string message) => Engine.Warn(message, PlaybackSpot);

        /// <summary>
        /// Logs an error to the console; will include script name and line number of the command.
        /// </summary>
        public void Err (string message) => Engine.Err(message, PlaybackSpot);
