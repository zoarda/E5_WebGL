...
public class StartNani : MonoBehaviour
{
    ...
    [Header("Button")]
    public Button buttonController, Btn_C1_VB, Btn_C2_VB, Btn_C3_VB, Btn_C4_VB, Btn_C5_VB;
    [SerializeField]
    ...
    Btn_EndGame, Btn_Artist, Btn_OK, Btn_No, Btn_InGameOK, Btn_InGameNo, Btn_Language, Btn_OptionReturn, Btn_LanguageReturn, Btn_ArtistReturn, Btn_Error,
     Btn_SelectOption, Btn_Return, Btn_StartSelect, Btn_StartGame, Btn_GameSetting, Btn_OpenPageCheck;
    ...
    async void Init()
    {
        ...
        //設定初始選擇按鈕(給遙控器用)
        // EventSystem.current.SetSelectedGameObject(Btn_StartGame.gameObject);
        //若是用andriod或ios開啟 將開頭動畫提示開啟 諾是pc或web 直接開始撥放openpage
